...
var BaseLineGraph = function BaseLineGraph(options) {
  var setupEventHandlers = function setupEventHandlers() {
    ...
    this._boundOnMetricData = this.onMetricData.bind(this);

    options.metricsProvider.on("metrics", this._boundOnEvent);
    options.metricsProvider.on("metricData", this._boundOnMetricData);
  }.bind(this);
...
BaseLineGraph.prototype.onMetricData = function () {
  throw new Error("BaseLineGraph onMetricData should be overwritten");
};
...
BaseLineGraph.prototype.changeMetricData = function (mapper) {
  ...
  _.each(data[0], function (value, seriesName) {
    ...
    this.series[seriesName].x = this.metricsProvider.getXAxis(this.layoutConfig.limit);
  }.bind(this));
...
BaseLineGraph.prototype.destroy = function () {
  ...
  this.metricsProvider.removeListener("metricData", this._boundOnMetricData);

  this._boundOnEvent = null;
  this._boundOnMetricData = null;
